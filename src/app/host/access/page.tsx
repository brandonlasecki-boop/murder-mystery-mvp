  ...
  useEffect(() => {
    ...
    async function run() {
      ...
      try {
        ...
        if (!res.ok) throw new Error(json?.error || "Could not redeem that code.");
    ...
    >
      <style jsx>{`
        * { box-sizing: border-box; }
        ...
        .h1 { margin: 10px 0 0; font-size: 30px; font-family: ${theme.serif}; }
      ...
      <div className="wrap">
        <div className="card">
          ...
          {!err ? <div className="pill">⏳ Checking code…</div> : null}
